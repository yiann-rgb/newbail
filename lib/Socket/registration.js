...
function mobileRegisterCode(params, fetchOptions) {
  ...
  return mobileRegisterFetch("/code", {
    params: {
      ...
      call_log_permission: params?.method === "flash" ? "true" : "false",
      education_screen_displayed: "false",
      prefer_sms_over_flash: params?.method === "flash" ? "false" : "true",
      device_ram: "5.59",
      manage_call_permission: params?.method === "flash" ? "true" : "false",
      client_metric:
