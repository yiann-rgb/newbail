...
const getMobileUserAgent = (config) => {
    return {
        ...
        platform: config.business ? WAProto_1.proto.ClientPayload.UserAgent.Platform.ANDROID_BUSINESS : WAProto_1.proto.ClientPayload.UserAgent.Platform.ANDROID,
        releaseChannel: WAProto_1.proto.ClientPayload.UserAgent.ReleaseChannel.RELEASE,
        device: 'sagit',
        osVersion: '11',
        osBuildNumber: '11.0.0',
        mcc: '510',
        mnc: '01',
        localeLanguageIso6391: 'en',
